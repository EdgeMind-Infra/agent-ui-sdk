...
export interface ThreadListChatProviderProps {
  ...
  /** ChatProvider props (components, config, toolRenderers). */
...
/**
 * Inner component that bridges ThreadListProvider's activeThreadId
 * with useBranchedChat's threadId parameter.
 */
  ...
  return (
    <ChatProvider
      ...
      config={{
        ...
        getBranches: branched.getBranches,
        onSwitchBranch: branched.switchBranch,
        onRestoreCheckpoint: branched.restoreCheckpoint,
      }}
      toolRenderers={chatProviderProps?.toolRenderers}
    >
      {children}
    </ChatProvider>
  );
